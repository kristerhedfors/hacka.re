...
window.ToolDebugger = (function() {
    ...
    function addSampleTool(toolKey) {
        ...
        if (window.ApiToolsService && typeof ApiToolsService.init === 'function') {
    ...
    async function executeMockToolCall(toolName, args) {
        ...
        try {
            // Generate a mock response directly instead of using ApiToolsService
            if (mockResponses[toolName]) {
                ...
                console.log(`Generated generic mock response for "${toolName}":`, mockResult);
                return mockResult;
            }
        } catch (error) {
